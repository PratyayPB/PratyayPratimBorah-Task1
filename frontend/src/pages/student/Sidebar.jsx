 ...
 */
export default function Sidebar({ activePage, onSwitch }) {
  const activeItem = activePage === "student" ? "dashboard" : "assignment";
          ...
          return (
            <a
              ...
              style={{
                ...
                color: isActive ? "#005bbf" : "#5f6368",
                fontWeight: isActive ? 600 : 500,
                boxShadow: isActive ? "0 2px 8px rgba(0,91,191,0.08)" : "none",
              }}
              onMouseEnter={(e) => {
                if (!isActive) e.currentTarget.style.background = "#e7e8e9";
              }}
              onMouseLeave={(e) => {
                if (!isActive) e.currentTarget.style.background = "transparent";
              }}
            >
              <span style={{ color: isActive ? "#005bbf" : "#727785" }}>
                {icons[key]}
              </span>
              {label}
            </a>
